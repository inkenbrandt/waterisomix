...
*This package would benefit from contributors.*


## TODO

- [ ] Finish creating example .py files into notebooks
- [ ] Add content from manuscript to notebooks to clarify scripts
- [ ] Turn iteration in example files into classes and functions
- [ ] Convert R scripts into python scripts
- [ ] Determine requirements for final scripts
